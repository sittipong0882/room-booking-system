...
function Room5() {
  ...
  async function getCalendarEvents() {
    const response = await fetch("https://www.googleapis.com/calendar/v3/calendars/c_b6c44e704bb0a6238f77863629a3dabc0e748ee8af4cd1a3b438a0cbe740da8c@group.calendar.google.com/events", {
      method: "GET",
      headers: {
  ...
  async function createCalendarEvent() {
    ...
    await fetch("https://www.googleapis.com/calendar/v3/calendars/c_b6c44e704bb0a6238f77863629a3dabc0e748ee8af4cd1a3b438a0cbe740da8c@group.calendar.google.com/events", {
      method: "POST",
        headers: {
            Authorization: 'Bearer ' + session.provider_token,
  ...
  return (
    <div className="App">
      <div className="container">
        {session ? (
          <>
            <h2>ยินดีต้อนรับ, {session.user.email} ห้องหมายเลข 5</h2>
          ...
          <>
          <h2>กรุณาเข้าสู่ระบบเพื่อจองห้องประชุมหมายเลข 5</h2>
