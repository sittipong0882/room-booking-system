...
function Room1() {
  ...
  async function getCalendarEvents() {
    const response = await fetch("https://www.googleapis.com/calendar/v3/calendars/c_b7c5b7960d5b1d32a0b629fe71012a533de7e7329ed492e6d56a014d9f22224e@group.calendar.google.com/events", {
      method: "GET",
      headers: {
  ...
  async function createCalendarEvent() {
    ...
    await fetch("https://www.googleapis.com/calendar/v3/calendars/c_b7c5b7960d5b1d32a0b629fe71012a533de7e7329ed492e6d56a014d9f22224e@group.calendar.google.com/events", {
      method: "POST",
      headers: {
        Authorization: 'Bearer ' + session.provider_token,
        ...
        {session ? (
          <>
            <h2 style={{
              ...
              ยินดีต้อนรับ, {session.user.email} ห้องหมายเลข 10
            </h2>
