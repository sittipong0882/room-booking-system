...
function Room4() {
  ...
  async function getCalendarEvents() {
    const response = await fetch("https://www.googleapis.com/calendar/v3/calendars/c_9349fd476a9e740771bc73620c0006d45b181505fda20730de028f2f8de10325@group.calendar.google.com/events", {
      method: "GET",
      headers: {
  ...
  async function createCalendarEvent() {
    ...
    await fetch("https://www.googleapis.com/calendar/v3/calendars/c_9349fd476a9e740771bc73620c0006d45b181505fda20730de028f2f8de10325@group.calendar.google.com/events", {
      method: "POST",
        headers: {
            Authorization: 'Bearer ' + session.provider_token,
  ...
  return (
    <div className="App">
      <div className="container">
        {session ? (
          <>
            <h2>ยินดีต้อนรับ, {session.user.email} ห้องหมายเลข 4</h2>
