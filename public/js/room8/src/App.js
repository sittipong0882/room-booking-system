...
function Room1() {
  ...
  async function getCalendarEvents() {
    const response = await fetch("https://www.googleapis.com/calendar/v3/calendars/c_8b061dc7f81545b067a50ca597ee4a6be6abdc1aadeb85fa68525c86524bf603@group.calendar.google.com/events", {
      method: "GET",
      headers: {
  ...
  async function createCalendarEvent() {
    ...
    await fetch("https://www.googleapis.com/calendar/v3/calendars/c_8b061dc7f81545b067a50ca597ee4a6be6abdc1aadeb85fa68525c86524bf603@group.calendar.google.com/events", {
      method: "POST",
      headers: {
        Authorization: 'Bearer ' + session.provider_token,
        ...
        {session ? (
          <>
            <h2 style={{
              ...
              ยินดีต้อนรับ, {session.user.email} ห้องหมายเลข 8
            </h2>
          ...
          <div style={{
              ...
              height: "3vh", // ให้เต็มจอแนวตั้ง
              textAlign: "center" // จัดข้อความให้อยู่ตรงกลาง
            }}></div>
            <h2>กรุณาเข้าสู่ระบบเพื่อจองห้องประชุมหมายเลข 8</h2>
            <button
