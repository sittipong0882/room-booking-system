...
function Room1() {
  ...
  async function getCalendarEvents() {
    const response = await fetch("https://www.googleapis.com/calendar/v3/calendars/c_97923f05a9e6c79b7516856b54a834ae0ba29ea558d69a3cff389a6f2ff44252@group.calendar.google.com/events", {
      method: "GET",
      headers: {
  ...
  async function createCalendarEvent() {
    ...
    await fetch("https://www.googleapis.com/calendar/v3/calendars/c_97923f05a9e6c79b7516856b54a834ae0ba29ea558d69a3cff389a6f2ff44252@group.calendar.google.com/events", {
      method: "POST",
      headers: {
        Authorization: 'Bearer ' + session.provider_token,
        ...
        {session ? (
          <>
            <h2 style={{
              ...
              ยินดีต้อนรับ, {session.user.email} ห้องหมายเลข 6
            </h2>
          ...
          <div style={{
            ...
            <h2>กรุณาเข้าสู่ระบบเพื่อจองห้องประชุมหมายเลข 6</h2>
            <button
